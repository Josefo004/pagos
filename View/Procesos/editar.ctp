...
<div class="procesos form">
    ...
    <fieldset>
        ...
        <div class="left"><?php echo $this->Form->input('nro_proceso', array('label' => 'N° de Proceso', 'disabled' => 'disabled')); ?></div>
        <div class="left"><?php echo $this->Form->input('fecha_emision', array('label' => 'Fecha de Emisión', 'type' => 'text', 'after' => '&nbsp;<input id="BtnFechaEmision" type="button" value="..." />', 'readonly' => 'true', 'size' => 10)); ?></div>
        <div class="clear"></div>
        ...
        <div class="left"><?php echo $this->Form->input('monto'); ?></div>
        <div class="clear"></div>
