<div class="procesos menu">
        ...
        <li>
            ...
            <ul>
                <li>
                    ...
                    echo $this->Html->link('[2.1] Recepción (' . $pendientes['2'] . ')<span>Contabilidad</span>', array('action' => 'pendientes', 'mayor' => $params['mayor'], 'estado' => 2), array('escape' => false, 'class' => 'habilitado ' . $class)); 
                    ?>
                </li>
                <li>
                    <?php 
                    $class = ($params['estado'] == '3')?'seleccionado':'';
                    echo $this->Html->link('[2.2] Revisión<span>Analistas</span>', array('action' => 'index', 'mayor' => $params['mayor'], 'estado' => 3), array('escape' => false, 'class' => 'habilitado ' . $class)); 
                    ?>
                </li>
                <li>
                    <?php 
                ...
                <li>
                    ...
                    echo $this->Html->link('[2.4] Sin observación (' . $pendientes['5'] . ')<span>Contabilidad</span>', array('action' => 'pendientes', 'mayor' => $params['mayor'], 'estado' => 5), array('escape' => false, 'class' => 'habilitado ' . $class));
                    ?>
                </li>
            </ul>
        </li>
    ...
    <?php if ($params['mayor'] == 'si') : ?>        
        ...
        <li>
            ...
            echo $this->Html->link('[7] Entrega de Cheque<span>Caja</span>', array('action' => 'index', 'mayor' => $params['mayor'], 'estado' => 12), array('escape' => false, 'class' => 'no-habilitado ' . $class)); 
            ?>
        </li>
        <li>
            <?php 
            $class = ($params['estado'] == '13')?'seleccionado':'';
            echo $this->Html->link('[8] Archivo<span>Archivo</span>', array('action' => 'index', 'mayor' => $params['mayor'], 'estado' => 13), array('escape' => false, 'class' => 'no-habilitado ' . $class));
            ?>
        </li>
    <?php else : ?>
        <li>
            ...
            echo $this->Html->link('[4] Firma de Cheque (' . $pendientes['8'] . ')<span>Contabilidad</span>', array('action' => 'pendientes', 'mayor' => $params['mayor'], 'estado' => 8), array('escape' => false, 'class' => 'habilitado ' . $class)); 
            ?>
        </li>
        <li>
            <?php 
            $class = ($params['estado'] == '12')?'seleccionado':'';
            echo $this->Html->link('[5] Entrega de Cheque<span>Caja</span>', array('action' => 'index', 'mayor' => $params['mayor'], 'estado' => 12), array('escape' => false, 'class' => 'no-habilitado ' . $class)); 
            ?>
        </li>
        <li>
            <?php 
