        ...
        <li>
            ...
            <ul>
                <li>
                    ...
                    echo $this->Html->link('[3.1] Recepción', array('action' => 'pendientes', 'mayor' => $params['mayor'], 'estado' => 6), array('escape' => false, 'class' => 'no-habilitado ' . $class));
                    ?>
                </li>
                <li>
                    <?php 
                    $class = ($params['estado'] == '7')?'seleccionado':'';
                    echo $this->Html->link('[3.2] Impresión (' . $pendientes['7'] . ')<span>Tesorería</span>', array('action' => 'pendientes', 'mayor' => $params['mayor'], 'estado' => 7), array('escape' => false, 'class' => 'habilitado ' . $class));
                    ?>
                </li>
            </ul>
        </li>
