        ...
        <li>
            ...
            <ul>
                ...
                <li>
                    ...
                    echo $this->Html->link('[2.3] Con observación (' . $pendientes['4'] . ')<span>Administradores</span>', array('action' => 'pendientes', 'mayor' => $params['mayor'], 'estado' => 4), array('escape' => false, 'class' => 'habilitado ' . $class)); 
                    ?>
                </li>
                <li>
                    <?php 
