        ...
        <li>
            ...
            <ul>
                <li>
                    ...
                    echo $this->Html->link('[2.1] Recepción<span>Contabilidad</span>', array('action' => 'pendientes', 'mayor' => $params['mayor'], 'estado' => 2), array('escape' => false, 'class' => 'no-habilitado ' . $class)); 
                    ?>
                </li>
                <li>
                    <?php 
                    $class = ($params['estado'] == '3')?'seleccionado':'';
                    echo $this->Html->link('[2.2] Revisión (' . $pendientes['3'] . ')<span>Analistas</span>', array('action' => 'pendientes', 'mayor' => $params['mayor'], 'estado' => 3), array('escape' => false, 'class' => 'habilitado ' . $class)); 
                    ?>
                </li>
                <li>
                    <?php 
