<div class="procesos menu">
    ...
    <?php if ($params['mayor'] == 'si') : ?>
        ...
        <li>
            ...
            echo $this->Html->link('[7] Entrega de Cheque<span>Caja</span>', array('action' => 'pendientes', 'mayor' => $params['mayor'], 'estado' => 12), array('escape' => false, 'class' => 'no-habilitado ' . $class)); 
            ?>
        </li>
        <li>
            <?php 
            $class = ($params['estado'] == '13')?'seleccionado':'';
            echo $this->Html->link('[8] Archivo (' . $pendientes['13'] . ')<span>Archivo</span>', array('action' => 'pendientes', 'mayor' => $params['mayor'], 'estado' => 13), array('escape' => false, 'class' => 'habilitado ' . $class));
            ?>
        </li>
    <?php else : ?>
        <li>
        ...
        <li>
            <?php 
            $class = ($params['estado'] == '13')?'seleccionado':'';
            echo $this->Html->link('[6] Archivo (' . $pendientes['13'] . ')<span>Archivo</span>', array('action' => 'pendientes', 'mayor' => $params['mayor'], 'estado' => 13), array('escape' => false, 'class' => 'habilitado ' . $class));
            ?>
        </li>
    </ul>
    <?php endif; ?>
