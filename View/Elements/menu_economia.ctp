<div class="procesos menu">
    ...
    <?php if ($params['mayor'] == 'si') : ?>
        ...
        <li>
            ...
            echo $this->Html->link('[5] Firma de Cheque (' . $pendientes['10'] . ')<span>Stria. Economía</span>', array('action' => 'pendientes', 'mayor' => $params['mayor'], 'estado' => 10), array('escape' => false, 'class' => 'habilitado ' . $class)); 
            ?>
        </li>
        <li>
            <?php 
