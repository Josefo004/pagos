<div class="procesos menu">
    <ul>
        ...
        <li>
            <?php 
            echo $this->Html->link('[3] Elaboración de Cheque', 'javascript:void()', array('escape' => false, 'class' => 'no-habilitado'));
            ?>
            <ul>
                <li>
                    <?php 
                    $class = ($params['estado'] == '6')?'seleccionado':'';
                    echo $this->Html->link('[3.1] Recepción (' . $pendientes['6'] . ')<span>Tesorería</span>', array('action' => 'pendientes', 'mayor' => $params['mayor'], 'estado' => 6), array('escape' => false, 'class' => 'habilitado ' . $class));
                    ?>
                </li>
                <li>
                    <?php 
                    $class = ($params['estado'] == '7')?'seleccionado':'';
                    echo $this->Html->link('[3.2] Impresión<span>Tesorería</span>', array('action' => 'pendientes', 'mayor' => $params['mayor'], 'estado' => 7), array('escape' => false, 'class' => 'no-habilitado ' . $class));
                    ?>
                </li>
            </ul>
        </li>
