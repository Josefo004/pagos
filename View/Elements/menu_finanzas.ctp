<div class="procesos menu">
    <ul>
        <li>
            ...
            echo $this->Html->link('[1] Ingreso de Documentos<span>Dir. Finanzas</span>', array('action' => 'index', 'mayor' => $params['mayor'], 'estado' => 1), array('escape' => false, 'class' => 'habilitado ' . $class)); 
            ?>
        </li>
        <li>
            <?php 
        ...
        <li>
            <?php 
            echo $this->Html->link('[3] Elaboración de Cheque', 'javascript:void(0)', array('escape' => false, 'class' => 'no-habilitado ' . $class));
            ?>
            <ul>
                <li>
                    <?php 
    ...
    <?php if ($params['mayor'] == 'si') : ?>
        <li>
            ...
            echo $this->Html->link('[4] Firma de Cheque (' . $pendientes['9'] . ')<span>Dir. Finanzas</span>', array('action' => 'pendientes', 'mayor' => $params['mayor'], 'estado' => 9), array('escape' => false, 'class' => 'habilitado ' . $class)); 
            ?>
        </li>
        <li>
            <?php 
        ...
        <li>
            ...
            echo $this->Html->link('[6] Cheque concluído (' . $pendientes['11'] . ')<span>Dir. Finanzas</span>', array('action' => 'pendientes', 'mayor' => $params['mayor'], 'estado' => 11), array('escape' => false, 'class' => 'habilitado ' . $class)); 
            ?>
        </li>
        <li>
            <?php 
            $class = ($params['estado'] == '12')?'seleccionado':'';
            echo $this->Html->link('[7] Entrega<span>Caja</span>', array('action' => 'index', 'mayor' => $params['mayor'], 'estado' => 12), array('escape' => false, 'class' => 'no-habilitado ' . $class)); 
            ?>
        </li>
        <li>
            <?php 
    ...
    <?php else : ?>
        ...
        <li>
            <?php 
            $class = ($params['estado'] == '12')?'seleccionado':'';
            echo $this->Html->link('[5] Entrega de Cheques<span>Caja</span>', array('action' => 'index', 'mayor' => $params['mayor'], 'estado' => 12), array('escape' => false, 'class' => 'no-habilitado ' . $class)); 
            ?>
        </li>
        <li>
            <?php 
